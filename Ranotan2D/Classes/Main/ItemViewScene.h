...
#define TAG_ITEMVIEW_PARTICLE (10012)
...
private:
    ...
    void setReflectParticle(CCPoint point);
...
private:
    ...
    bool createDetailText(int parentTag, int tag);
    void createItemNavi();
    ...
    void removeAllChildParts(bool isNaviItem);
